...
$dob_err = $first_err = $last_err = $gender_err = $phno_err = $payment_err = $seats_err = "";
...
if(isset($_POST["submit"])){
    ...
    if(empty($dob_err) && empty($first_err) && empty($last_err) && empty($gender_err) && empty($phno_err) && empty($payment_err) && empty($seats_err)){
        $query = "INSERT INTO booking_table (user_id,match_id,first_name,last_name,DOB,gender,Ph_no,payment,no_of_seats) VALUES 
        ('$uid','$match_no','$first','$last','$dob','$gender','$phno','$payment','$seats')";	
            ...
            <form action="" method="post" >
                    ...
                    <div class="input_field">
                     ...
                     <div class="input_field">
                           ...
                           <div class="input_field">
                           <label>Seats : </label>
                           <input type="number" name="seats" id="name" value="<?php echo htmlspecialchars($seats) ?>" placeholder="Enter number of seats"> <br><br>
                           </div>
                           <div class="red-text"><?php echo $seats_err ?></div>

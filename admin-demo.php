...
<link rel="stylesheet" href="stylesheets/admin-demo.css">
    ...
    <h1 class="match-heading">GROUND INFORMATION</h1>
        ...
        <div class="row">
            <?php  foreach($stadium as $std): ?>
               ...
               <label for="ground" > 
               <input type="radio" value="stad-<?php echo htmlspecialchars($std['stadium_id']);?>" name="ground" class="card-input-ele" 
               ...
               <div class="card card-default card-input">
                   <br>
                    ...
                    <div class="card-body">
                        <h5 class="card-title1"><?php echo htmlspecialchars($std['stadium_name']); ?></h5>
                        <h6 class="card-subtitle1 mb-2 text-muted"><?php echo htmlspecialchars($std['stadium_city']); ?></h6>
                    </div>
                    </label>
            </div>
               </div>
        ...
        <div class="row">
            <?php  foreach($teams as $t): ?>
                ...
                <label for="1team">
                        ...
                        <h6 class="card-subtitle mb-2 text-muted"><?php echo htmlspecialchars($t['name']); ?></h6>
                    </div>
                        </label>
                    </div>
                </div>

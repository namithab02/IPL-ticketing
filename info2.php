...
if(isset($_POST['submit1'])){
       $result1 = mysqli_query($conn,"CALL batting('$year1','$year2','$player1','$team','$player2')")  or die("Error: " . mysqli_error($c)); 
       ...
       $result2 = mysqli_query($conn,"CALL bowling('$year1','$year2','$player2','$team','$player1')")  or die("Error: " . mysqli_error($c)); 
       $row2 = mysqli_fetch_assoc($result2);

}
else if(isset($_POST['submit2'])){
    $result1 = mysqli_query($conn,"CALL batting('$year1','$year2','$player1','$team','$extra')")  or die("Error: " . mysqli_error($c)); 
    $row1 = mysqli_fetch_assoc($result1);
    while(mysqli_more_results($conn) && mysqli_next_result($conn)) {
      $dummyResult = mysqli_use_result($conn);
      if($dummyResult instanceof mysqli_result) 
    ...
    $result2 = mysqli_query($conn,"CALL batting('$year1','$year2','$player2','$team','$extra')")  or die("Error: " . mysqli_error($c)); 
    $row2 = mysqli_fetch_assoc($result2);
}
else if(isset($_POST['submit3'])){
  $result1 = mysqli_query($conn,"CALL bowling('$year1','$year2','$extra','$team','$player1')")  or die("Error: " . mysqli_error($c)); 
  $row1 = mysqli_fetch_assoc($result1);
   while(mysqli_more_results($conn) && mysqli_next_result($conn)) {
     $dummyResult = mysqli_use_result($conn);
     if($dummyResult instanceof mysqli_result) 
  ...
  $result2 = mysqli_query($conn,"CALL bowling('$year1','$year2','$extra','$team','$player2')")  or die("Error: " . mysqli_error($c)); 
  $row2 = mysqli_fetch_assoc($result2);
}
    ...
    <div class="row">
      <div class="col-lg-4">
          <form id="res" method="POST" action="">
                <br><br>
                <h3> GET PERFORMANCE OF</h3><br><br>
